...
// export const updateMyProfile = async (req, res) => {
//   try {
//     const { name, department, year, matricNumber, staffId, bio, avatar } = req.body;
...
//       if (matricNumber) user.profile.matricNumber = matricNumber;
//     }

//     // 🔹 Staff
//     if (user.role === "staff") {
//       if (staffId) user.profile.staffId = staffId;
//     }
